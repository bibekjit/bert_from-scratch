...
#
#
# text = """well 6000 welled000 will USER 4yell USER USER 5willed pin pinned pinn yelled telling welling 6play slay will
# playn played walked000 walking 4walking LINK LINK 6playing LINK 6playing playing shall will wall walling pin plin"""
#
# x = "playingx"
# # print(x)
# tok1 = BytePairEncodingTokenizer(maxlen=10,num_tokens=20)
# tok1([text])
# tok1.train(2,2,special_tokens=['USER','LINK'])
# print(tok1.i2w)
